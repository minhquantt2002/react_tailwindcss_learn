...
const choices: Choice[] = [
  {
    ...
    shadowClass: "shadow-[-1rem_-1rem_0_0_#FFFBEC]",
  },
  {
    ...
    shadowClass: "shadow-[-1rem_-1rem_0_0_#F9ECFF]",
  },
  {
    ...
    shadowClass: "shadow-[-1rem_-1rem_0_0_#ECEEFF]",
  },
];
...
export const Subscription = () => {
  return (
    <div className="space-y-14 rounded-3xl bg-[#F4F5FA] p-20">
      <div>
        <h1 className="text-center font-meri text-3xl font-black [text-wrap:balance]">
          Get the most out of your mobile with the right subscription
        </h1>

        <p className="mt-6 text-center font-popi text-lg [text-wrap:balance]">
      ...
      <div className="grid grid-cols-3 gap-8">
        {choices.map((choice) => (
          <div className={`rounded-xl bg-white p-10 ${choice.shadowClass}`}>
            ...
            <p className="font-popi text-sm">{choice.subtitle}</p>
            <div className="mt-4 flex items-center">
              <span className="text-2xl font-bold">{choice.price},-</span>
              <span className="text-sm">/month</span>
            </div>
            <button className="mt-6 rounded-full border-[1px] border-[#F0F0F6] px-6 py-4 shadow-[0px_4px_0px_0px_#E8E7FB;]">
              Add subscription
            </button>
          </div>
        ))}
      ...
      <div className="text-center">
        <button className="items-center rounded-full bg-[#171435] p-4 py-3 text-white">
